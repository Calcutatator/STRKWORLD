"""Read live v4 GP geometry/materials after the coordinator reopens the master.
...
for direction in data['directions']:
    ...
    for layer in ob.data.layers:
        ...
        for stroke in layer.frames[0].drawing.strokes:
            ...
            region['contours'].append([[point.position.x + 32, 32 - point.position.z] for point in stroke.points])
